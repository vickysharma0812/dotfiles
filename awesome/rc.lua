...
kbdcfg.add_primary_layout("Japanese", "JP", "jp")
kbdcfg.bind()
...
run_once({ "urxvtd", "unclutter -root", "dropbox start", "picom", "xscreensaver -nosplash" }) -- comma-separated entries

awful.spawn.with_shell(os.getenv("HOME") .. "/.config/awesome/autorun.sh")

-- number pad, from: https://www.reddit.com/r/awesomewm/comments/ptn0au/awesome_how_to_activate_numpad_at_startup/
...
local chosen_theme = themes[mytheme1]
local modkey = "Mod4"
local altkey = "Mod1"
local terminal = "alacritty" or "kitty"
local vi_focus = false  -- vi-like client focus https://github.com/lcpz/awesome-copycats/issues/275
local cycle_prev = true -- cycle with only the previously focused client or all https://github.com/lcpz/awesome-copycats/issues/274
local editor = "hx" or "code"
...
-- Shift-Alt to change keyboard layout
  ...
  awful.key({ modley, altkey }, "k", function()
    awful.client.focus.byidx(-1)
  ...
  awful.key({ modkey }, "x", function()
    os.execute(
      string.format(
        "rofi -show %s -theme %s",
        "drun",
        os.getenv("HOME") .. "/.config/rofi/launchers/type-5/style-4.rasi"
      )
    )
